    ...
    try {
        ...
        fetch(`https://www.udemy.com/api-2.0/search-courses/?src=ukw&q=${query}`, {
          ...
          .then((data)=>{
            ...
            fetch(`https://www.udemy.com/api-2.0/pricing/?course_ids=${all_course_ids}&fields[pricing_result]=price,discount_price,list_price,price_detail,price_serve_tracking_id`, {
              "headers": {
                "accept": "application/json, text/plain, */*",
                "accept-language": "en-US,en;q=0.9",
                "cache-control": "no-cache",
            ...
            .then((data)=>{
              ...
              console.log("1st final course",all_courses[0]);
